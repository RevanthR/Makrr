    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b border-[var(--border)] bg-white/80 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <Link
              href="#contact"
              className="rounded-full bg-gradient-to-r from-violet-600 to-amber-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:opacity-95"
            >
              Start a Project
            </Link>
          </div>
      ...
      >
        <div className="flex min-h-full flex-col items-center justify-center gap-8 px-6 pt-20 pb-12">
          ...
          <Link
            href="#contact"
            className="rounded-full bg-gradient-to-r from-violet-600 to-amber-500 px-8 py-4 text-lg font-semibold text-white shadow-sm"
            onClick={closeMenu}
          >
            Start a Project
          </Link>
